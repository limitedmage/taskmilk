...
* Popup closes when clicking a dropdown box. This is a known bug in Chromium: http://code.google.com/p/chromium/issues/detail?id=28110 but it is marked as fixed, so this should be fixed in Chrome builds soon.
...
Please report any issues on the Google Code project page: http://code.google.com/p/chromemilk/issues/
